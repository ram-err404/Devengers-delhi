...
var2 = ['I_was_created_by_Ramji_right_in_his_computer.', 'Ramji', 'Some_guy_whom_i_never_got_to_know.']
...
while True:
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            print("You said:- " + audio_str)
        except sr.UnknownValueError:
            print("Could not understand audio")
            engine.say('I didnt get that. Rerun the code')
            engine.runAndWait()

    if audio_str in greetings:
        print("Ramji: I came here")
        random_greeting = random.choice(greetings)
        print(random_greeting)
        espeak.synth(random_greeting)
        ...
        engine.say('I was made by Ramji Misra')
        engine.runAndWait()
